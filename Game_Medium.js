    ...
    create() {
        ...
        **/
        ...
        for(var i = 0; i < amountStone; i++) {
            if(i > 0){
                stones[i] = this.physics.add.sprite(Phaser.Math.Between(50, (game.config.width-50)), stones[i-1].y - 700, 'Stone');
            }
            else{
        ...
        setInterval(function() { 
            ...
            if (sec == 0 || lives == 0) {
                ...
                if(stone.y > (catcher.y + 50)){
                    stone.x = Phaser.Math.Between(50, (game.config.width-50));
                    stone.y = 0;
                }
            }
        }, 20);
